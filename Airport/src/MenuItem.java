...
/*
 * MenuItem is used by a MyMenu object to map a menu option to a target method. With the
 ...
 * a MenuItem. Each MyMenu object will also have a MenuItem instance used to define an exit
...
public class MenuItem {
    ...
    /*
     * Use this constructor to create a MenuItem to be used in a parent MyMenu.
    ...
    /*
     * This method is called by a parent MyMenu when the option that this MenuItem is
     ...
     * approach eliminates the need for a selection process in MyMenu as each MenuIeem
     * can invoke itself.
     */
    void invoke() {
    ...
    /* This method tells MyMenu if 'this' is an exit option or not. */
    boolean isExitItem() { return isExitItem; }

    /* MyMenu uses this method to tell 'this' it will be an exit option */
