...
public class Menu {
    ...
    private static Menu dashboardMenu;
    private boolean isDashboardMenu;
    ...
    public Menu() {
        ...
        if (Menu.rootMenu == null) {
            ...
            this.exitItem = new MenuItem("Iseiti"); // A root menu will exit from the program
        } else if (Menu.dashboardMenu == null) {
            this.isDashboardMenu = true;
            Menu.dashboardMenu = this;

            this.exitItem = new MenuItem("Atsijungti");
        } else {
            this.exitItem = new MenuItem("Atgal"); // A sub menu will go back one level
        }
    ...
    private void print() {
        ...
        for (int i = 0; i < this.itemList.size(); i++)
            sb.append("\n").append("[").append(i + 1).append("]").append(" ").append(this.itemList.get(i).getLabel());

        sb.append("\n").append("[").append(getExitIndex()).append("]").append(" ").append(exitItem.getLabel());
        sb.append("\n> ");
